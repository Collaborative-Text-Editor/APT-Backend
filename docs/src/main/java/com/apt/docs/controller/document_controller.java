...
public class document_controller {
    ...
    public document_controller(document_service documentService, document_permission_service documentPermissionService) {
    ...
    // public Iterable<document_permission> getEditorsOfDocument(@PathVariable int id){
